function [Rx] = Build_BLT_Rx(gam1,gam2,d,nu,Y,rho,E)
...
%             jb = jj;
%         end
%         Rx(kk) = (gam1(kk)/nu(kk))*d(kk)*exp(rho*gam2(kk)*(Y(jb) - Y(ib)));
%         
%         % Increment
%         kk = kk+1;
%     end
